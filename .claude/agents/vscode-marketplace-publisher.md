...
description: VS Code extension marketplace publishing specialist. Handles extension packaging, publishing, metadata optimization, version management, and marketplace guideline compliance.
model: sonnet
---
