...
description: NPM package publishing and configuration specialist. Handles package.json setup, semantic versioning, CI/CD automation, scoped packages, and publishing workflows.
model: sonnet
---
